...
<template>
    <form class="mx-auto mt-10 flex max-w-md flex-col gap-4 rounded-md bg-white p-8 shaow-lg" @submit.prevent="addEmployee">
        ...
        <button typ="submit" class="bg-green-500 px-4 py-2">Submit</button>
    </form>
</template>